...
//    static String[] TypeEasy = {"t", "t", "t", "t", "t", "t", "t", "t", "t",
...
//			"", "", "", "", "", "", "" };
    ...
    static String[] TextEasy = {
            ...
            "Who is having the best one day bowling figures",
            "Who was the first player to score a One Day International century",
            "Who hit the winning runs in India’s famous NatWest final victory against England in 2002",
            "Against which team did India win its first One Day International match",
            "Who topped the batting averages for England in the 2003 World Cup",
            "Who won 'Man of the Tournament' award in the 1992 World Cup",
            "Who was Sri Lanka’s first one day captain",
            "Against which team did Brian Lara’s hit the largest odi score",
            "Which team did Sri Lanka dismiss for the lowest one day total ever",
            "Name the umpire who has officiated in both the cricket and football World Cups",
            "Who holds the record for most One Day International wickets",
            "Who holds the record for most dismissals",
            "Who holds the record for most nineties in career",
            "Who holds the record for most catches in career (non wicket keeper)",
            "Which was the 1st non Test playing country to beat India in an international match",
            "Which team has played most number of Cricket Test Matches",
            "Which team is holding the record of fewest runs in an inning in Test Cricket",
            "Which Bowler has taken most number of 5 wickets in an innings in Test Cricket",
            "Which player has Most matches played as captain in Test Cricket",
            "NEITHER GODS NOR MEN WILL EVER COMPEL ME TO LET YOU TURN CASTERLY ROCK INTO YOUR WHOREHOUSE.",
            "Who has the Highest Individual score in ODIs",
            "Which was the 1st non Test playing country to beat India in an international match",
            "Where was the final match of ICC World Cup 2007, between Australia and Sri Lanka, played", "India's highest run chase of 321 is against which team?",
            "Which team is the highest chaser in ODI cricket",
            "At Which Stadium did south africa made a record chase",
            "Who bowled the first ball of icc world cup 2015",
            "who was the first batsmen to get out in icc world cup 2015",
            "Last bowl of the icc world cup was bowled by",
            "world cup 1975 finals' highest scorer",
            "who was the last man to get out in world cup 1975",
            "Most no of matches as an Umpire",
            "who is the slowest run scorer in test cricket",
            "which player has the longest interval between appearances",
            "Who has been the youngest captain in test cricket",
            "Player with maximum no of times as test captain",
            ...
            "which player always puts on his left pad first while going out to bat",
            "which player wears a jersey with the number 12 on it since his birthday is on the 12th of December, which also happens to be the 12th month of the year. He considers it to be his lucky number. He also wears a black thread on his wrist",
            "which player listens to loud music before going out to bat",
            "Born on July 7, he considers it as his lucky number. He sports number seven on his jersey",
            "which indian seamer considers a yellow handkerchief as his lucky charm",
            "which Australian captain used to carry a red handkerchief in his left pocket which was known to be given by his grandfather once"};

    static String[] AnswerEasy = {"Sanath Jayasuriya", "Corey Anderson",
            "Chaminda Vaas", "Dennis Amiss", "Zaheer Khan", "East Africa",
            "Paul Collingwood", "Martin Crowe", "Anura Tennekoon", "Sri Lanka",
            "Zimbabwe", "Steve Bucknor", "Muttiah Muralitharan", "Adam Gilchrist",
            "Sachin Tendulkar", "Mahela Jayawardene", "Sri Lanka", "new zealand", "Muttiah Muralitharan",
            "Graeme Smith", "rohit sharma", "Sri Lanka", "Barbados",
            "Bridgetown", "Sri Lanka", "South Africa", "Wanderers Stadium",
            "Nuwan Kulasekera", "BB McCullum", "Henry", "CH Lloyd",
            "JR Thomson", "RE Koertzen", "Hanif Mohammad", "John Traicos",
            "Tatenda Taibu", "Graeme Smith", "ian botham",
            "richie benaud", "shane warne", "murray walker", "Matthew Hayden",
            "Rahul dravid", "Imran khan", "Donald bradman", "sachin tendulkar",
            "yuvraj Singh", "michael clarke", "Ms Dhoni", "zaheer khan", "Steve Waugh"};

//	static String[] typeMed = { "t", "t", "t", "t", "t", "t", "t", "t", "t",
//			"t", "t", "t", "t", "t", "t", "t", "t", "t", "t", "t", "t", "t",
//			"t", "t", "t", "t", "t"};
...
//			};
//
//	static String[] ansmed = { };

//	static String[] typehard = { "t", "t", "t", "t", "t", "t", "t", "t", "t",
//			"t", "t", "t", "t", "t", "t", "t", "t", "t", "t", "t", "t", "t",
//			"t" };
//
...
//			"Petyr Baelish" };
//
//	static String[] typevhard = { "t", "t", "t", "t", "t", "t", "t", "t", "t",
//			"t", "t" };
//
